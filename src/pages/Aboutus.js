  ...
  return (
    <div
      ...
      <div className={AboutCss.about1}>
        ...
        <hr></hr>
        <p className={AboutCss.aboutabstract}>{t("aboutus_text")}</p>
        ...
        <Container style={{ marginTop: "55px" }}>
          <Row>
            <Col md={4}>
              ...
              <p className={AboutCss.goals}>{t("aboutus_text2")}</p>
            </Col>
            <Col md={4}>
              <FaCrown className={AboutCss.featureIcon} />
              <h4>{t("aboutus_text3")}</h4>
              <p className={AboutCss.goals}>{t("aboutus_text4")}</p>
            </Col>
            <Col md={4}>
              <FaHandsHelping className={AboutCss.featureIcon} />
              <h4> {t("aboutus_text5")} </h4>
              <p className={AboutCss.goals}>{t("aboutus_text6")}</p>
            </Col>
          </Row>
        </Container>
      </div>
        ...
        <Container>
          <Row>
            ...
            <Col md={7}>
              ...
              <p className='lead'>{t("proposal_txt")}</p>
              <Link to={"/contact"}>
