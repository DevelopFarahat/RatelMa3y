...
const SystemUsers = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (userData._id === "") {
      ...
      axios
        .put(
          `https://ratel-may.herokuapp.com/api/instructors/${userData._id}`,
          {
            email: userData.email,
            name: userData.name,
            gender: userData.gender,
  ...
  return (
    <>
      ...
      >
        <div
          className={SystemUsersStyles["system-user-steps-circle-container"]}
        >
          <Form.Control
            name="_id"
            id="_id"
        ...
        {systemUsersFormSteps.firstStep ? (
          <>
            ...
            <div>
              ...
              <Form.Select
                ...
                onChange={handleChange}
                className={`${SystemUsersStyles["system-user-form-controls"]} ${
                  errors.programsError ? SystemUsersStyles["errors"] : ""
                }`}
              >
          ...
          <>
            ...
            <div
              className={`${SystemUsersStyles["days-check-box-container"]} ${
            ...
            >
              {" "}
              <ImPrevious2 style={{ margin: " -3px -7px 0 3px" }} />{" "}
              {t("prevoius")}
            </button>
            <button
              type="submit"
                ...
                {accountsData?.map((userAccount) => (
                  <tr
                    ...
                    style={{
                      ...
                      color: selectedRow === userAccount._id ? "#FFFFFF" : "",
                      boxShadow:
